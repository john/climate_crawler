...
class CarbSpider(scrapy.Spider):
    ...
    start_urls = ["https://ww2.arb.ca.gov/sitemap.xml?page=1", "https://ww2.arb.ca.gov/sitemap.xml?page=2"]
    allowed_domains = ["ww2.arb.ca.gov"]
    visited_urls = set()
    ...
    def parse(self, response):
        ...
        container_name = 'carb-crawl'  # Specify the desired container name
